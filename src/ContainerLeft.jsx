    ...
    return(
        <div className="flex max-w-1/3 justify-between flex-col pl-40 pt-20 pb-20 min-h-dvh">
            ...
            <div className='flex flex-row justify-between w-1/2'>
                ...
                <a className="text-(--primary) text-left" href="https://www.linkedin.com/in/euan-jones" target="_blank">
                ...
                <a className="text-(--primary) text-left" href="https://devpost.com/euanajones" target="_blank">
                ...
                <a className="text-(--primary) text-left" href="https://buymeacoffee.com/euanjones" target="_blank"s>
